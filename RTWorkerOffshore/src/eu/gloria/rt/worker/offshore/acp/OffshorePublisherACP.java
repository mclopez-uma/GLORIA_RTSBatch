...
import eu.gloria.rt.worker.offshore.acp.rtml.RtmlSkyCondition;
...
public class OffshorePublisherACP extends OffshorePluginPublisher implements OffshorePublisher{
	...
	public void publish(String idOp) throws RTSchException {
		...
		String acp_constraint_sky_condition = getPropertyValueString("acp_constraint_sky_condition");
		...
		try{
			...
			if (dbOp != null){
				...
				try{
					...
					if (acp_constraint_sky_condition != null){
						context.setSkyCondition(RtmlSkyCondition.valueOf(acp_constraint_sky_condition));
					}
